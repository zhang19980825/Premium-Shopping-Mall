package com.zhangyang.service.weixin;
...
public class WxPayServiceImpl {
    ...
    public PayResponse pay(PayRequest request) {
        ...
        wxRequest.setAppid("wxgq6ue658o0nbn139");
        //待处理 ---开始
        wxRequest.setMchId("6413850021");
        wxRequest.setNotifyUrl("http://api.xdclass.net/notify");  //异步调用的地址
        //待处理 --结束
