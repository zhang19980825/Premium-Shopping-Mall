...
public class SolrUtil {
	...
	private static final String SOLR_URL = "http://192.168.96.152:8888/solr/collection1"; // 服务器地址
	...
	public static List<String> searchqyinfofromsolr(String searchname)
	...
	public static void main(String[] args) throws Exception {
		...
		mapValue.put("id","8");
		mapValue.put("productdescription","好丑的大哈哈");
		addIndex2(mapValue);
